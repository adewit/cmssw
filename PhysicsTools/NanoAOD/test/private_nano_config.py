...
# with command line options: --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step NANO --scenario pp --era Run3 --python_filename private_nano_config.py --fileout file:HIG-Run3Summer22EENanoAODv12-00588.root --filein file:input.root -n -1 --no_exec --mc
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-Run3Summer22EENanoAODv12-00588.root'),
