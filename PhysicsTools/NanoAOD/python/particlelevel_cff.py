...
HTXSCategoryTable = cms.EDProducer("SimpleHTXSFlatTableProducer",
    ...
    variables=cms.PSet(
        ...
        stage_1p1_cat = Var("stage1p1_cat",int, doc="HTXS stage-1p1 category (jet pt>30 GeV)"),
        stage_1p1_uncert_cat = Var("stage1p1_uncert_cat",int, doc="HTXS stage-1p1 category for uncertainties(jet pt>30 GeV)"),
        ...
        jeteta = Var("jeteta",float, doc="number of jets with pt>25 GeV as identified in HTXS"),
   )
)
