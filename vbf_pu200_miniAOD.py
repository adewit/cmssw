...
# with command line options: vbf_pu200_miniAOD_1 -s PAT --eventcontent MINIAODSIM --runUnscheduled --mc --filein root://cms-xrd-global.cern.ch//store/mc/PhaseIIFall16DR82/VBFHToTauTau_M125_14TeV_powheg_pythia8/AODSIM/PU200_90X_upgrade2023_realistic_v1-v1/130000/0007A233-9AF5-E611-A9C5-0025905A6066.root --no_exec --datatier MINIAODSIM --conditions 90X_upgrade2023_realistic_v1 --era Phase2C2_timing -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('vbf_pu200_miniAOD nevts:10000'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('vbf_pu200_miniAOD_PAT.root'),
